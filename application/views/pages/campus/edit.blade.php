                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $campus->name }}" name="name" type="text" class="form-control" id="name" placeholder="Campus Name">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $campus->city }}" name="city" type="text" class="form-control" id="city" placeholder="Campus City">
